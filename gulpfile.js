/**
 *   Gulp with Bootstrap 
 *   Author : bridgesense.com llc
 **/

/**
* The original setup here is based off of  Manjunath's work with
* TailwindCSS
* 
* If you've used his repository, you'll recognize this: 
* https://github.com/lazymozek/gulp-with-tailwindcss
**/

/*
  Usage:
  1. yarn # To install all dev dependencies of package
  2. yarn dev # To start development and server for live preview
  3. yarn prod # To generate minifed files for live server
*/
